...
type Spec struct {
	...
	Service string `protobuf:"bytes,2,opt,name=service,proto3" json:"service" validate:"required"`
	// @gotags: json:"resource" validate:"required"
	Resource string `protobuf:"bytes,3,opt,name=resource,proto3" json:"resource" validate:"required"`
	// @gotags: json:"action" validate:"required" gorm:"json"
	Action []string `protobuf:"bytes,4,rep,name=action,proto3" json:"action" validate:"required" gorm:"json"`
...
var file_apps_role_pb_model_proto_rawDesc = []byte{
	...
	0x74, 0x22, 0x8a, 0x01, 0x0a, 0x04, 0x53, 0x70, 0x65, 0x63, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61,
	...
	0x20, 0x03, 0x28, 0x09, 0x52, 0x06, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x20, 0x0a, 0x0b,
